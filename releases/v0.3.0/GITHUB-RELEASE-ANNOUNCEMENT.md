...
The [Constitutional Traceability Matrix](../../conformance/CONSTITUTIONAL-TRACEABILITY-MATRIX-v0.1.md) makes the evidence chain visible from constitutional principle through DCS requirement, reference architecture, implementation, conformance test, and operational evidence. CRS v1.0 and CAIP v1.0 are intentionally marked pending until separately ratified.
