# C03 — Lineage Continuity Benchmark

**Status:** Draft — Specified  
**Domain:** Evidence Decisions

## Purpose

Evaluate the v0.2 → v0.3 continuity claim. Bind registry snapshots, migration evidence, conformance reports, and an explicit no-break or violation result.
