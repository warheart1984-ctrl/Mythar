...
- [CEM–DOS integration profile](specifications/MYTHAR-CEM-DOS-INTEGRATION-PROFILE-v0.1.md)
- [AAES-OS integration draft](specifications/MYTHAR-AAES-OS-INTEGRATION-v0.1-DRAFT.md)
