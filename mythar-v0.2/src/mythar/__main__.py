...
translate_cmd = commands.add_parser("translate"); translate_cmd.add_argument("source"); translate_cmd.add_argument("--source-language", choices=["mythar", "zh"], default="mythar")
...
if args.command == "translate":
    ...
    print(translate_isf(to_isf(result, args.source_language)))
    sys.exit(0)
