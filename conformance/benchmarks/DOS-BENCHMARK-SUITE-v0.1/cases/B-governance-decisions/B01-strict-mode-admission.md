# B01 — Strict Mode Admission Benchmark
...
Evaluate whether `tila` may be admitted to strict mode using its purity/refinement lineage, registry status, and conformance evidence. The benchmark must distinguish evidence review from a ratification decision.
